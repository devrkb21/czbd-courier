...
class PaperflyServiceTest extends TestCase
{
    ...
    {
        Config::set('courier-checker.paperfly.user', 'paperfly_user');
        Config::set('courier-checker.paperfly.password', 'paperfly_password');
    ...
    {
        Config::set('courier-checker.paperfly.user', 'primary_user');
        Config::set('courier-checker.paperfly.password', 'wrong_pass');
        Config::set('courier-checker.paperfly.users', 'backup_user');
        Config::set('courier-checker.paperfly.passwords', 'backup_pass');
